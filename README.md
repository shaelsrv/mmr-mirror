# mirror — a Model Meets Reality starter
...
> State a specific, dated revision you expect the author's own models to undergo.

And when a claim comes due:

> Did the predicted revision occur?
...
python -m suites.new_model my-model --kind mirror \
